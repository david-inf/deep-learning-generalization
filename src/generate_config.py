...
if __name__ == "__main__":
    ...
    # param_seq = generate_dicts(model_name="MLP1", probs=[0.0], corrups=CORRUPS)
    ...
    # param_seq = generate_dicts(model_name="MLP3", probs=PROBS, corrups=["none"])
    # param_seq = generate_dicts(model_name="MLP3", probs=[0.0], corrups=CORRUPS)
